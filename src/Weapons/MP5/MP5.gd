...
var modification_offsets: Dictionary = {
	"suppressor1_auto":Vector2(345,0),
	"suppressor2_auto":Vector2(355,0),
	"suppressor3_auto":Vector2(365,2),
	"compensator1_auto":Vector2(335,0),
	"compensator2_auto":Vector2(345,2),
	"compensator3_auto":Vector2(350,2),
	"default_mp5_stock":Vector2(-320,0),
	"wide_stock":Vector2(-400,0),
}
...
func draw_attachments():
	...
	if (attachments["stock"] != ""):
		...
		$Sprite/Stock_attachment.texture = load(Global.weapon_attachment_paths["default_mp5_stock"])
		$Sprite/Stock_attachment.offset = modification_offsets["default_mp5_stock"]
