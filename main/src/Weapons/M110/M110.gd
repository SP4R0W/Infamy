...
var modification_offsets: Dictionary = {
	"suppressor2_auto":Vector2(590,0),
	"suppressor3_auto":Vector2(600,0),
	"compensator2_auto":Vector2(570,0),
	"compensator3_auto":Vector2(575,0),
}
...
func draw_attachments():
	...
	if (Game.get_skill("mastermind",1,3) != "none"):
		accuracy += int(accuracy * 0.1)
