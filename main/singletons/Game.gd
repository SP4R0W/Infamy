...
var stolen_cash_bags: int = 0
var stolen_cash_loose: int = 0
var killed_civilians_penalty: int = 0

var xp_earned: int = 0
var xp_earned_bags: int = 0
var xp_earned_stealth: int = 0
...
var player_weapon: int = -1
var player_disguise: String = "normal"
...
var max_handcuffs: int = 3
var handcuffs: int = 3

var max_bodybags: int = 1
var bodybags: int = 1

# skill related variables

var desperado_kill_counter: int = 0
var desperado_active: bool = false

var locknload_kill_counter: int = 0
var locknload_active: bool = false

var golden_kill_counter: int = 0
var golden_active: bool = false

var donor_kill_counter: int = 0

var is_bulletstorm_active: bool = false

var unbreakable_cooldown: bool = false
var push_it_cooldown: bool = false
